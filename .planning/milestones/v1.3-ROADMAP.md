...
- [x] **Phase 20: SEED-002 Embedding Vector Reuse (DET-01)** - Re-analysing an unchanged case reuses stored vectors instead of re-embedding, closing the ADR 0014 exposure (completed 2026-07-30)
