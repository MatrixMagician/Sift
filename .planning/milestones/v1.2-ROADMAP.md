...
- [x] **Phase 13: Episode Correlation, Hazard Flags & `sift perfmon` Report + CSV** - Each MCM episode annotated with its corroborating counter trend over MCM-04's existing lead-up window, deterministic correlation-hazard flags, shipped as the standalone `sift perfmon <case>` report + CSV (PERF-04, PERF-05, PERF-06) (completed 2026-07-20)
