...
- [ ] **Phase 15: Thread-Role Taxonomy & Rules File** - Every thread carries a deterministic role from an editable versioned rules file; unknown frames are reported, never guessed
...
| 15. Thread-Role Taxonomy & Rules File | v1.3 | 0/6 | In Progress|  |
